...
PROMPT = (
    ...
    "文字の傾き・トリミング・影・手による隠れなどで一部が判読しづらい"
    "場合でも、textフィールドには判読できた本文の内容のみを記載して"
    "ください。撮り直しを促す文言、判読できない理由の説明、謝罪や"
    "断り書きなど、本文以外のコメントは一切書かないでください。"
    "判読できない箇所は省略するか文脈から推測して埋めてください。"
)
